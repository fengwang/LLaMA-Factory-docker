...
RUN apt-get install -y git && python3.10 -m pip uninstall -y transformer-engine flash-attn && MAX_JOBS=4 python3.10 -m pip install --no-cache-dir flash-attn --no-build-isolation
